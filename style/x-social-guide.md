...
Generate **both** formats; pick one at publish time.

### Thread

- Tweet 1: hook — payoff or pain point (≤280 chars)
- Tweets 2–N: one concrete takeaway per tweet
- Final tweet: link to `canonical_url` + 0–2 hashtags

### Single tweet

- One announcement with link (≤280 chars)
- Lead with payoff, not "new blog post"
